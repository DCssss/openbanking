...
public final class PaymentConsentConverter {
    ...
    public static PaymentConsentEntity toPaymentConsentEntity(final OBDataTaxReq data) {
        final Date now = new Date();
        final ObjectMapper objectMapper = new ObjectMapper();
        String initiationBlock;
        try {
        ...
        paymentConsentEntity.setCreationTime(now);
        paymentConsentEntity.setStatus(StatusPaymentConsent.AWAITINGAUTHORISATION);
        paymentConsentEntity.setType(TypePaymentConsent.TAXREQUIREMENTCONSENT);
        paymentConsentEntity.setInitiation(initiationBlock);
        paymentConsentEntity.setAuthorizationType(data.getAuthorisation().getAuthorizationType());
        paymentConsentEntity.setStatusUpdateTime(now);
        paymentConsentEntity.setInstructionId(data.getInitiation().getInstructionIdentification());
    ...
    public static OBDataTaxReq1 toOBDataTaxReq1(final PaymentConsentEntity paymentConsentEntity) {
        final ObjectMapper objectMapper = new ObjectMapper();
    ...
    public static OBDataTaxReq2 toOBDataTaxReq2(final PaymentConsentEntity paymentConsentEntity) {
        final ObjectMapper objectMapper = new ObjectMapper();
        OBInitiationTaxReq initiation;
        try {
            initiation = objectMapper.readValue(paymentConsentEntity.getInitiation(), OBInitiationTaxReq.class);
